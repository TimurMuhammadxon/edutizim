...
namespace OnlineTesting.Infrastructure.Migrations
{
    ...
    [Migration("20260823173459_AddCrmCore")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineTesting.Domain.Crm.Client", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AssignedManagerId")
                        .HasDatabaseName("ix_clients_assigned_manager_id");
            ...
            modelBuilder.Entity("OnlineTesting.Domain.Crm.CrmTask", b =>
                {
                    ...
                    b.HasIndex("ClientId")
                        .HasDatabaseName("ix_crm_tasks_client_id");

                    b.HasIndex("DealId")
                        .HasDatabaseName("ix_crm_tasks_deal_id");
            ...
            modelBuilder.Entity("OnlineTesting.Domain.Crm.Deal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AssignedManagerId")
                        .HasDatabaseName("ix_deals_assigned_manager_id");

                    b.HasIndex("ClientId")
                        .HasDatabaseName("ix_deals_client_id");

                    b.HasIndex("CourseId")
                        .HasDatabaseName("ix_deals_course_id");
